tidem.astron <- function(t)
{
    ...
    ##cat("d=",formatC(d,digits=10),"D=",D,"a=", a, "\n")
    ...
    ttrunc <- as.POSIXct(trunc.POSIXt(t, units="days"),tz="GMT")
    ##print(t-ttrunc)
    ##cat("t orig :");print(t);     cat(unclass(t)[1],"\n")
    ##cat("t trunc=");print(ttrunc);cat(unclass(ttrunc)[1],"\n")
    rem <- as.numeric(t - ttrunc)
    ##cat("rem=",rem,"\n")
