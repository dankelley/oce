                ...
                for (chunk in 1:header$numberOfDataTypes) {
                    ...
                    if (buf[o] == 0x00 & buf[1+o] == 0x00) {
                        ...
                        if (isSentinel) {
                            ...
                            warning("Detected vertical beam data chunk (0x00 0x0a at o=", o, "), but this is not a SentinelV\n")
                        }
                        ...
                        if (isSentinel) {
                            ...
                            warning("Detected vertical beam amplitude chunk (0x00 0x0c at o=", o, "), but this is not a SentinelV\n")
                        }
                        ...
                        if (isSentinel) {
                            ...
                            warning("Detected vertical beam correlation chunk (0x00 0x0b at o=", o, "), but this is not a SentinelV\n")
                        }
                        ...
                        if (isSentinel) {
                            ...
                            warning("Detected vertical beam percent-good chunk (0x00 0x0d at o=", o, "), but this is not a SentinelV\n")
                        }
                    } else {
