    ...
    haveAnalog1=FALSE, haveAnalog2=FALSE, debug=getOption("oceDebug"), monitor=FALSE, processingLog=NULL)
{
    ...
    bisectNortekVectorSd <- function(tFind, add=0, debug=0) {
        ...
        for (pass in 1:passes) {
            ...
            oceDebug(debug, "examine: t=", format(t), " middle=", middle,
    ...
    if (haveIMU) {
        ...
        if (buf[imuStart[1]+5] == 0xc3) {
            ...
            warning("unknown IMU type, with 5th byte 0x", buf[imuStart[1]+5],
    ...
    oceDebug(debug, "about to trim vsdStart, based on vvdStart[1]=", vvdStart[1],
