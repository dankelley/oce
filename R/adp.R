...
#' @param j optional string specifying a sub-class of \code{which}. For
...
setMethod(f="plot",
                              ...
                              ...)
          {
              ...
              oceDebug(debug, "plot,adp-method(x,",
                       ...
                       ", j=", if (missing(j)) "(missing)" else paste("\"", j, "\"", sep=""), "\"",
                       ", ...) {\n", sep="", unindent=1)
...
#' (It is worth noting that multiplier in the \eqn{e}{e} equation is subject to
#' discussion; RDI suggests one multiplier, but some oceanographers favour
#' another.)
#'
