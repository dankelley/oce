...
png("oce-demo-1.png", width=1050, height=1050, pointsize=26, bg="transparent")
par(lwd=3)
...
data(adp)
png("oce-demo-2.png", width=1050, height=1050, pointsize=32, bg="transparent")
par(lwd=3)
plot(adp)
dev.off()
...
data(sealevel)
m <- tidem(sealevel)
png("oce-demo-3.png", width=1050, height=1050, pointsize=26, bg="transparent")
par(lwd=3)
par(mfrow=c(2, 1))
...
png("oce-demo-5.png", width=1050, height=600, pointsize=26, bg="transparent")
par(lwd=3)
par(mar=rep(0.5, 4))
...
data(landsat)
png("oce-demo-6.png", width=600, height=600, pointsize=18, bg="transparent")
par(lwd=3)
plot(landsat)
dev.off()
