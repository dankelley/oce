...
png("oce-demo-1.png", width = f * 1050, height = f * 1050, pointsize = f * 26)
par(lwd = 3)
...
data(adp)
png("oce-demo-2.png", width = f * 1050, height = f * 1050, pointsize = f * 32)
par(lwd = 3)
plot(adp)
dev.off()
...
data(sealevel)
m <- tidem(sealevel)
png("oce-demo-3.png", width = f * 1050, height = f * 1050, pointsize = f * 26)
par(lwd = 3)
par(mfrow = c(2, 1))
...
data(echosounder)
png("oce-demo-4.png", width = f * 1050, height = f * 600, pointsize = f * 24)
par(lwd = 3)
...
png("oce-demo-5.png", width = f * 1050, height = f * 600, pointsize = f * 26)
par(lwd = 3)
par(mar = rep(0.5, 4))
...
data(landsat)
png("oce-demo-6.png", width = f * 600, height = f * 600, pointsize = f * 24)
par(lwd = 3)
plot(landsat)
dev.off()
