     e             12.1,    -0.2,     8.3,    -2.5,    -3.4,   -13.1,   
     f             -5.3,     2.4,     7.2,     8.6,    -0.6,    -8.7,   
     g              0.8,   -12.8,     9.8,    -1.3,    -6.4,     3.3,   
     h              0.2,     0.1,     2.0,     2.5,    -1.0,     5.4,   
     i             -0.5,    -9.0,    -0.9,     0.4,     1.5,    -4.2,   
     j              0.9,    -3.8,    -2.6,     0.9,    -3.9,    -9.0,   
     k              3.0,    -1.4,     0.0,    -2.5,     2.8,     2.4,   
     l             -0.6,    -0.6,     0.1,     0.0,     0.5,    -0.6,   
     m             -0.3,    -0.1,    -1.2,     1.1,    -1.7,    -1.0,   
     n             -2.9,    -0.1,    -1.8,     2.6,    -2.3,    -2.0,   
     o             -0.1,    -1.2,     0.4,     0.6,     1.2,     1.0,   
     p             -1.2,    -1.5,     0.6,     0.0,     0.5,     0.6,   
     q              0.5,    -0.2,    -0.1,     0.8,    -0.5,     0.1,   
     r             -0.2,    -0.9,    -1.2,     0.1,    -0.7,     0.2,   
     s              0.2,    -0.9,    -0.9,     0.6,     0.7,     0.7,   
     t              1.2,    -0.2,    -0.3,     0.5,    -1.3,     0.1,   
     u             -0.1,     0.7,     0.2,     0.0,    -0.2,     0.3,   
     v              0.5,     0.2,     0.6,     0.4,    -0.6,    -0.5,   
     w             -0.3,    -0.4,    -0.5/                              
      data gt/     12.6,    10.0,   -21.5,   -11.2,    -5.3,   -27.3,   
     1             -8.3,   -11.1,    -1.5,    -4.4,     3.8,     0.4,   
     2             -0.2,   -15.6,    -3.9,    -1.7,    -2.3,    -1.3,   
     3             -5.8,     4.1,     5.4,     1.6,    -6.8,    -4.1,   
     4              0.6,     1.3,    -0.5,     0.0,     2.1,     0.7,   
     5              0.5,     2.3,     1.7,     1.0,     1.9,    -0.2,   
     6             -0.3,     0.3,     0.8,    -1.6,     1.2,    -0.4,   
     7             -0.8,     0.8,     0.4,     0.7,     0.9,     0.9,   
     8             -0.1,    -0.1,     0.6,    -0.1,     0.5,     0.5,   
     9             -0.7,    -0.1,     0.0,    -0.8,    -0.9,    -0.8,   
     a              0.5,     0.9,    -0.3,    -0.1,     0.2,    -0.3,   
     b              0.0,     0.4,     0.4,    -0.3,    -0.1,     0.4,   
     c              0.3,    -0.5,     0.1,    -0.6,     0.0,     0.3,   
     d              0.3,     0.2, 115*0.0/                              
c
...
c      if (date.gt.2030.0) write (6,960) date
c  960 format (/' This version of the IGRF is intended for use up',
c     1        ' to 2030.0.'/' values for',f9.3,' will be computed',
...
c
      if (date.lt.1995.0) then
       ...
       nc    = nmx*(nmx+2)
c *** oce: BEGIN BLOCK
c *** oce: cast to int, to prevent compiler warning
...
c
      ...
      q(3)  =  ct
c *** oce START BLOCK
c *** oce: change 'do 10' to simple 'do', to prevent problems with compiler
c *** oce: changes
c      do 10 k=2,kmx                                                       
c *** oce END BLOCK
      do k=2,kmx                                                       
...
c     2        '.le.2035.0. On return f = 1.0d8., x = y = z = 0.')
      return
      end
