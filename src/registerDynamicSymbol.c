...
extern SEXP _oce_do_interp_barnes(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP,
                                  SEXP, SEXP, SEXP);
...
extern SEXP _oce_do_ldc_rdi_in_file_new(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP,
                                        SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_oce_do_landsat_transpose_flip", (DL_FUNC)&_oce_do_landsat_transpose_flip,
     1},
    {"_oce_do_landsat_numeric_to_bytes",
     (DL_FUNC)&_oce_do_landsat_numeric_to_bytes, 2},
    ...
    {"_oce_locateVectorImuSequences", (DL_FUNC)&_oce_locateVectorImuSequences,
     1},
