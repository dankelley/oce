...
test_that("read.ad2cp() on a secret file with only 'burst' data", {
          ...
          if (file.exists(f)) {
            ...
            expect_equal(dim(d[['a']]), c(999, 1, 4))
            expect_equal(dim(d[['a', 'numeric']]), c(999, 1, 4))
            expect_equal(dim(d[['a', 'raw']]), c(999, 1, 4))
            expect_equal(dim(d[['a', 'burst numeric']]), c(999, 1, 4))
            expect_equal(dim(d[['a', 'numeric burst']]), c(999, 1, 4))
            expect_equal(dim(d[['a', 'burst raw']]), c(999, 1, 4))
            expect_equal(dim(d[['a', 'raw burst']]), c(999, 1, 4))
