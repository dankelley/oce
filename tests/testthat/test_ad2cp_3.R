...
if (file.exists(file)) {
    ...
    test_that("signature 250 average", {
        ...
        expect_equal(
            a[["v"]][1:3, 1:3, 1:3],
            structure(c(
                -0.553, -0.542, -0.545, 2.255, -0.448, 1.695, 2.003,
                0.612, 2.415, 0.647, 0.641, 0.649, 1.701, 1.449, 1.762,
                0.861, 0.971, 1.773, 0.099, 0.065, 0.096, -0.239, -0.235,
                -0.217, -0.37, -0.365, -0.393
            ), dim = c(3L, 3L, 3L))
        )
        expect_equal(
            a[["a"]][1:3, 1:3, 1:3],
            structure(as.raw(c(
                0x6e, 0x6e, 0x6e, 0x34, 0x35, 0x34, 0x24, 0x22,
        ...
        expect_equal(
            a[["q"]][1:3, 1:3, 1:3],
            structure(as.raw(c(
                0x20, 0x21, 0x21, 0x15, 0x0d, 0x19, 0x1d, 0x15,
        ...
        expect_equal(
            ...
            structure(
                c(
                    1653479685.6677, 1653479687.6677, 1653479689.6677,
