...
## Do we get the early-end indication? (There are also two warnings)
d <- expect_warning(expect_output(read.oce(file), "^.*wanted 16032 bytes but got only 7186.*$"))
