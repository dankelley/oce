...
test_that("Moon", {
          ...
          expect_lt(abs(m$lambda - 133.162659), 0.02)
          expect_lt(abs(m$beta - -3.229127), 0.001)
          ##expect_equal(abs(m$obliquity - 23.440636) < 0.001)
          expect_lt(abs(m$rightAscension - 134.688473), 0.02)
          expect_lt(abs(m$declination - 13.768366), 0.01)
          expect_lt(abs(m$diameter - 0.991990), 0.0001)
          expect_lt(abs(m$distance - 368405.6), 20)
