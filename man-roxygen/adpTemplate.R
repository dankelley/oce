...
#' If \code{by} is not given, a default will be chosen based on the file size:
#' with file size under 1Mb, this will not skip profiles, but for larger
#' files, \code{by} will be set to yield approximately 500 profiles.
#'
