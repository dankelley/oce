...
#' An \code{\link{expression}} or list of expressions that contain
#' R code that will be executed immediately after each panel of the plot.
#' If the number of expressoins matches the number of panels, then the 
