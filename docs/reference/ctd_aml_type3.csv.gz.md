...
It is based on a file created with Sailfish 1.4.8.0 software, as
explained in an oce issue at
<https://github.com/dankelley/oce/issues/2247>. Only the first 5 data
