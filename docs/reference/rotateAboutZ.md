...
Alter the horizontal components of velocities in `adp`, `adv` or `cm`
objects, by applying a rotation about the vertical axis.
...
- x:
  ...
  [adv](https://dankelley.github.io/oce/reference/adv-class.md), or
