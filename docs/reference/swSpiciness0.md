...
for surface referenced computation.
...
seawater spiciness with respect to a reference pressure of 0 dbar (that
is, the sea surface), as defined in the `gsw` (TEOS-10) system
