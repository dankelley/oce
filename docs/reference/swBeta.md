...
The `eos="unesco"` formulae are based on the UNESCO equation of state,
but are formulated empirically by Trevor J. McDougall, 1987, Neutral
Surfaces, Journal of Physical Oceanography, volume 17, pages 1950-1964.
The `eos="gsw"` formulae come from GSW; see references in the
[`swRho()`](https://dankelley.github.io/oce/reference/swRho.md)
documentation.
