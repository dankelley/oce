...
#> ------------
#> 
#> * Source:              "/private/var/folders/8b/l4h64m1j22v5pb7vj049ff140000gn/T/Rtmpgd13QI/temp_libpath87af3fecbdce/oce/extdata/D4902337_219.nc"
#> * ID:                  "4902337"
...
#> * Processing Log
#> 
#>     - 2026-06-30 12:57:58 UTC: `create 'argo' object`
#>     - 2026-06-30 12:57:58 UTC: `initializeFlagScheme(object, name="argo", mapping=list(not_assessed=0,passed_all_tests=1,probably_good=2,probably_bad=3,bad=4,changed=5,not_used_6=6,not_used_7=7,estimated=8,missing=9)), default=c(0,3,4,9))`
#>     - 2026-06-30 12:57:58 UTC: `read.argo(file="/private/var/folders/8b/l4h64m1j22v5pb7vj049ff140000gn/T/Rtmpgd13QI/temp_libpath87af3fecbdce/oce/extdata/D4902337_219.nc")`
```
