...
#> * Processing Log
#> 
#>     - 2026-02-17 19:26:03 UTC: `create 'xbt' object`
#>     - 2026-02-17 19:26:03 UTC: `read.xbt.edf(file = file, longitude = longitude, latitude = latitude,     encoding = encoding, debug = debug - 1L, processingLog = processingLog)`
plot(xbt)
