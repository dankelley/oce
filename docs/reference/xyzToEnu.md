...
- ...:
  ...
  see the documentation for those functions, for the details.

## Value

An object of the same class as `x`, but with velocities in east-north-up
coordinates instead of xyz coordinates.
