...
#> * Processing Log
#> 
#>     - 2026-03-16 15:49:00 UTC: `create 'section' object`
#>     - 2026-03-16 15:49:00 UTC: `as.section(salinity = c("ctd", "fake"))`
...
#> 
#>     - 2026-03-16 15:49:00 UTC: `create 'section' object`
#>     - 2026-03-16 15:49:00 UTC: `as.section(salinity = ctds)`
# argo data (a subset)
data(argo)
...
#> 
#>     - 2026-03-16 15:49:00 UTC: `create 'section' object`
#>     - 2026-03-16 15:49:00 UTC: `as.section(salinity = subset(argo, profile < 5))`
```
