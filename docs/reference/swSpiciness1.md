...
- salinity:
  ...
  either salinity, or an oce object that contains salinity, temperature,
...
seawater spiciness with respect to a reference pressure of 1000 dbar, as
defined in the `gsw` (TEOS-10) system (McDougall et al, 2011) and
computed with
[`gsw::gsw_spiciness1()`](http://teos-10.github.io/GSW-R/reference/gsw_spiciness1.md).
