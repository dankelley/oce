...
Compute \\\sigma_t\\, a rough estimate of potential density of seawater,
minus 1000 kg/m\\^3\\.
...
Quasi-potential density anomaly (kg/m\\^3\\), defined as the density
calculated with pressure set to zero.

## Details

If the first argument is an
[oce](https://dankelley.github.io/oce/reference/oce-class.md) object,
then salinity, etc., are extracted from it, and used for the
calculation.
