...
Compute the potential density of seawater (minus 1000 kg/m\\^3\\),
...
if it is `"unesco"`. (The difference between the formulations is
typically under 0.01 kg/m^3, corresponding to a few millidegrees of
temperature.)
