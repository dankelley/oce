...
[`gsw::gsw_sound_speed()`](http://teos-10.github.io/GSW-R/reference/gsw_sound_speed.md)
function from the [gsw](https://CRAN.R-project.org/package=gsw) package
is used.
...
Science*, *44*, 53 pp. (See section 9.)
