...
Figures 1 and 3 show differing schemes for computing checksums, from References
1 and 2, respectively.  (Unhelpfully, the modern equivalent to Ref 1, that is,
Ref 3, has no sample code.)
...
\includegraphics[width=\hsize]{ref1_p47.png}

Ref 2 page 79

\includegraphics[width=\hsize]{ref2_p79.png}

Ref 2 page 8

\includegraphics[width=\hsize]{ref2_p8.png}
