...
files <- c(
    "/data/archive/sleiwex/2008/fielddata/2008-07-01/Merlu/Biosonics/20080701_163942.dt4",
...
expect_equal(head(echosounder[["latitude"]]),
    c(
        47.87948333, 47.87948333, 47.87948333, 47.87948825, 47.87949642,
        47.87950000
    ),
    tolerance = 0.000001
)
expect_equal(
    head(echosounder[["longitude"]]),
    c(
        -69.72364436, -69.72366061, -69.72367686, -69.72368808,
...
## be able to use data("echosounder")
