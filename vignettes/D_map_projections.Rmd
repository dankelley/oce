...
```{r fig.cap="Eastern North Atlantic with Mercator projection (exercise 4).", fig.width=5, fig.height=5, dpi=72, dev.args=list(pointsize=10)}
par(mar=c(1.5, 1.5, 0.5, 0.5))
mapPlot(coastlineWorld, col="lightgray",
...
```{r fig.cap="Eastern North Atlantic with Albers equal-area projection (exercise 5).", fig.width=5, fig.height=5, dpi=72, dev.args=list(pointsize=10)}
par(mar=c(1.5, 1.5, 0.5, 0.5))
mapPlot(coastlineWorld, col="lightgray",
