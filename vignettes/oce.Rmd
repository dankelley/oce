...
or Winkel Tripel for world-wide views; these are achieved as follows. (Note
that there are problems with the inverse of the Winkel Tripel distribution in
old versions of the `rgdal` library that is used for projections.)

```{r fig.keep="none"}
mapPlot(coastlineWorld, projection="+proj=moll") # Mollweide
mapPlot(coastlineWorld, projection="+proj=eck4") # Eckert IV
mapPlot(coastlineWorld, projection="+proj=wintri") # Winkel Tripel
```
