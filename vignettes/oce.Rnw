...
data(section, package="ocedata")
data(coastlineHalifax, package="ocedata")
...
<<>>=
library(oce)
data(topoWorld, package="ocedata")
...
data(sealevelHalifax, package="ocedata")
