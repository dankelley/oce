...
for general information about oce.  The sample code provided in this vignette
all relies on the oce package, so the first step in following along is to load
it:
```{r}
library(oce)
```
