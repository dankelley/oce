...
analysis code).  The better method is to simply supply desired properties to
relevant functions, e.g. calling `plotTS(...,eos="UNESCO")` to get a graph in an
old format that shows Potential Temperature vs Practical Salinity, if that is
required instead of the new standard of Conservative Temperature vs Absolute
Salinity.

| Name                     | Value                  | Settable as a function parameter |
| ------------------------ | ---------------------- | -------------------------------- |
