...
handle measurements made by acoustic Doppler profilers.  The goal is to get
users started, on the assumption that they will use the package documentation
to learn more details, and that they will consult [the main oce
vignette](oce.html) for general information about oce. The vignette is
organized roughly along the steps of typical processing, and the use of a
dataset provided by oce means that readers should find it easy to follow along.
Engagement is encouraged by the highlighting of some important elements of the
oce function documentation, and the provision of worked exercises.
