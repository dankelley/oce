...
seawater properties. Perhaps the most used is \verb@sw.rho(S,T,p)@,
...
provided with \verb@sw.sigma(salinity,temperature,pressure)@, or its
adiabatic cousin $\sigma_\theta$, provided with
\verb@sw.sigma.theta(salinity,temperature,pressure)@.
...
\verb@sw.S.C.T.p@ (salinity from conductivity, temperature and pressure),
\verb@sw.S.T.rho@ (salinity from temperature and density),
\verb@sw.T.S.rho@ (temperature from salinity and density),
...
sw.rho(34, 10, 100)
sw.theta(34, 10, 100)
sw.rho(34, sw.theta(34, 10, 100), 0)
sw.rho(34, sw.theta(34, 10, 100, 200), 200)
