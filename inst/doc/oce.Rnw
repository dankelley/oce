...
plot.ctd.scan(ctd.trim(ctd.raw, "range",
...
plot(Gulf.Stream.gridded, coastline=coastline.world, map.xlim=c(-85,-(64+13/60)))
@
...
<<label=sectionfiga03,fig=TRUE,width=8, height=9.5, echo=FALSE>>=
<<sectionplota03>>
@
\end{center}
