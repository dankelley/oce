...
---
<!-- edit vignettest/oce.Rmd then run with -->
...
another scheme.) To illustrate dealing with such data, we may alter the second
salinity, then set up a check for negative salinities:
data.
```{r}
# fake second datum
stn[["salinity"]][2] <- -999
