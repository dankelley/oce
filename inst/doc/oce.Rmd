...
processing of `oce` objects.  For example, if `x` is an `ctd`
object, then `plot(x)` produces a multi-panel plot with profiles and a map,
whereas if `x` is an `adp` object, then images will show the distance-time
