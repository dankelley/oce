...
function calls used in creating the object.

The object layout is illustrated by the results of executing the following in
an R session, for the case of an object of the `"ctd"` subclass, which holds
data acquired from a CTD (Conductivity-Depth-Pressure) instrument.
